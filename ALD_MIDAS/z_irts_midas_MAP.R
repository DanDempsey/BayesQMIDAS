...
setwd("~/Dropbox/PhD/MIDAS/IRTS_MIDAS/Code/")
source("midas_regimes.R")
source("midas_neg_logposterior.R")
source("irts_nealmon.R")
source("time_delta_matrix.R")
source("irts_midas_sim.R")
source("design_matrix.R")
source("irts_midas_MAP_fit.R")
source("nealmon_prior.R")
source("giveNames.R")
source("dry_glm_fit.R")
source("midas_formula_unpack.R")
source("MIDAS_start.R")
library(parallel)
library(tictoc)
